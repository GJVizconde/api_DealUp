...
const uploadFileImage = require('../controllers/Gallery_Project/uploadFileImage');
...
galleryRouter.post('/file', uploadFileImage.upload.single('image'), uploadFileImage.uploadFileImage);
